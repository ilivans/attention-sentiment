...
%\includegraphics[width=0.4\textwidth]{images/hist_bank.png}
%\includegraphics[width=0.4\textwidth]{images/hist_tkk.png}
%\\
%\includegraphics[width=0.4\textwidth]{images/hist_reviews.png}
%\includegraphics[width=0.4\textwidth]{images/hist_kinopoisk.png}
%\end{figure}
%
%\end{frame}
